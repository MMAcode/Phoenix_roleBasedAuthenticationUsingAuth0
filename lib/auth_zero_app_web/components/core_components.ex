defmodule Auth0AppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Auth0AppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Auth0AppWeb.Gettext, "errors", msg, opts)
    end
  end
